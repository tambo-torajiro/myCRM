...
const form = reactive({
    ...
    work_category: props.customer.work_category,
    tel: props.customer.tel,
    email: props.customer.email,
    postcode: props.customer.postcode,
    address: props.customer.address,
    person_in_charge1: props.customer.person_in_charge1,
    person_in_charge2: props.customer.person_in_charge2,
    person_in_charge3: props.customer.person_in_charge3,
    request_date: props.customer.request_date,
                                    ...
                                    <div class="mx-auto lg:w-1/2 md:w-2/3">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    <label for="tel"
                                                        class="text-sm leading-7 text-gray-600">電話番号</label>
                                            ...
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    <label for="person_in_charge1"
                                                        class="text-sm leading-7 text-gray-600">担当者01</label>
                                            ...
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    <label for="request_date"
                                                        class="text-sm leading-7 text-gray-600">依頼日</label>
